...
class FriendlyScreen extends StatefulWidget {
  ...
  @override
  State<FriendlyScreen> createState() => _FriendlyScreenState();
}

class _FriendlyScreenState extends State<FriendlyScreen> {
  DateTime selectedDate = DateTime.now();

  bool isDateOpen = false;
  String selectedOpponent = '';

  final List<String> opponentItems = [
    "Select Opponent",
  ];

  @override
  void initState() {
    selectedOpponent = opponentItems[0];
    super.initState();
  }
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton2(
                          ...
                          selectedItemBuilder: (BuildContext context) {
                            return opponentItems.map<Widget>((String item) {
                              return Align(
                          ...
                          onChanged: (value) {
                            setState(() {
                              selectedOpponent = value as String;
                            });
                          },
